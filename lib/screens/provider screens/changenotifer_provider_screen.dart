...
import 'package:learning_riverpod/screens/provider%20screens/cart_screen.dart';
...
class ChangeNotifierProviderScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    int productCount = ref.watch(cartNotifierProvider).cart.length;
    return Scaffold(
      appBar: AppBar(
        actions: [
          InkWell(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                bool productInCart =
                    ref.watch(cartNotifierProvider).containsProduct(product);
                return ListTile(
                  title: Text(
                    product.name!,
